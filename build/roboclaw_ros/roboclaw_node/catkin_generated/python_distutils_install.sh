...
echo_and_run cd "/home/jcosta/workspace/ROS/crawler/src/roboclaw_ros/roboclaw_node"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/jcosta/workspace/ROS/crawler/src/roboclaw_ros/roboclaw_node/setup.py" \
     \
    build --build-base "/home/jcosta/workspace/ROS/crawler/build/roboclaw_ros/roboclaw_node" \
    install \
    --root="${DESTDIR-/}" \
