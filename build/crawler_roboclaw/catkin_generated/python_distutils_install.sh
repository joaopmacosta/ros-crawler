...
echo_and_run cd "/home/jcosta/workspace/ROS/crawler/src/crawler_roboclaw"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/jcosta/workspace/ROS/crawler/src/crawler_roboclaw/setup.py" \
     \
    build --build-base "/home/jcosta/workspace/ROS/crawler/build/crawler_roboclaw" \
    install \
    --root="${DESTDIR-/}" \
